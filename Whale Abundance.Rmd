...
**Individuals**
\
The model estimated the average detectability of individual bowhead whales to be 0.47. 

The estimated abundance of individual Bowhead whales was highest in strata 2 (138.83, CI: 291.53; 66.11) and lowest in strata 15 (5.12, CI: 39.44; 0.67). Additionally
...
#skable(abundance_table_clu, caption = "Abundance Estimates for Clusters")
...
bowhead_LT %>%
  group_by(Region.Label) %>%
  drop_na() %>%
  summarise(total_num = sum(size), 
            times_seen = length(object))
