...
```{r Model Fit Plot, echo = FALSE, warning = FALSE, results = "hide", message = FALSE, out.width='0.8\\linewidth', fig.align="center"}
#####    SETTING UP    #####
...
```{r Individual Abundance Plot, echo = FALSE, warning = FALSE, results = "hide", message = FALSE, fig.show="hold", out.width="70%"}
...
\
```{r individual Density Plot, echo = FALSE, warning = FALSE, results = "hide", message = FALSE, fig.show="hold", out.width="70%"}
...
**Clusters**
\
```{r Cluster Abundance plot, echo = FALSE, warning = FALSE, results = "hide", message = FALSE, fig.show="hold", out.width="70%"}
## CLUSTERS ##
...
```
\
```{r Cluster Density Plot, echo = FALSE, warning = FALSE, results = "hide", message = FALSE, fig.show="hold", out.width="70%" }
