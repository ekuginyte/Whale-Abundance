...
\
```{r individual Density Plot, echo = FALSE, warning = FALSE, results = "hide", message = FALSE}
...
```
\
```{r Cluster Density Plot, echo = FALSE, warning = FALSE, results = "hide", message = FALSE }
