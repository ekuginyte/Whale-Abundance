...
Students: xxx, 180015716, 220013309
...
ggplot(N_ind)+
  ...
  labs(caption = 'Figure 2: The estimated Bowhead whale abundance of individuals in each strata (blue dot) and \n the confidence intervals (blue) lines)')+
  
  # Making the caption sit at the left
  theme(plot.caption = element_text(hjust = 0))+
  
  # Adding more Y axis ticks to make estimates easier to interpret
  scale_y_continuous(breaks = round(seq(min(fct_N_ind$lcl),
                                        max(fct_N_ind$ucl), 
                                        by = 100)))
...
ggplot(N_clu)+
  ...
  xlab('Survey Strata')+
  ylab('Estimated Abundance')+
  labs(caption = 'Figure 2: The estimated Bowhead whale abundance of clusters in each strata (green dot) and \n the confidence intervals (green lines)')+
...
# Plotting estimated density data 
ggplot(d_clu)+
  geom_point(aes(x = Label, y = Estimate), 
             stat = "identity", 
             size = 2,
  ...
  labs(caption = 'Figure 2: The estimated Bowhead whale density of clusters in each strata (green dot) and \n the confidence intervals (green lines)')+
  
  # Making the caption sit at the left
  theme(plot.caption = element_text(hjust = 0))+
  
  # Adding more Y axis ticks to make estimates easier to interpret
  scale_y_continuous(breaks = round(seq(min(d_clu$lcl),
                                        max(d_clu$ucl), 
                                        by = 0.001)))
```
